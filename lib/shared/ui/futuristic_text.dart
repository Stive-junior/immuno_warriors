...
class FuturisticText extends StatelessWidget {
  ...
  final List<Shadow>?
  shadows; // Ombres personnalisées (remplace withGlow si fourni).
  ...
  Widget build(BuildContext context) {
    ...
    final Color glowBaseColor =
        color ??
        AppColors
            .primaryColor; // Utilise la couleur du texte ou primaryColor pour la lueur
        ...
        shadows:
            ...
            (withGlow
                ? [
                  ...
                  Shadow(
                    color: glowBaseColor.withOpacity(
                      0.3,
                    ), // Lueur secondaire plus diffuse
                    blurRadius: 20,
                    offset: const Offset(0, 0),
                  ),
                ]
