...
class AddProfileCard extends StatelessWidget {
  ...
  final AnimationController addUserIconController; // Contrôleur pour l'animation de l'icône "ajouter utilisateur".
  final bool isCentered; // Indique si la carte est centrée (pour ajuster la taille de l'icône).
  ...
  Widget build(BuildContext context) {
    ...
    return FadeIn(
      duration: AppAnimations.cardAnimationDuration, // Durée d'animation d'entrée
      child: NeonCard(
        ...
        child: VirusButton(
          ...
          borderColor: AppColors.secondaryAccentColor, // Couleur de bordure du bouton
          ...
          child: SizedBox(
            ...
            child: Padding(
              ...
              child: Column( // Changé en Column pour un meilleur agencement vertical
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Semantics(
                    label: AppStrings.addNewAccount,
                    child: PulseWidget(
                      controller: addUserIconController, // Contrôleur de pulsation
                      minScale: 0.95,
                      maxScale: 1.05,
                      child: Image.asset(
                        ...
                        errorBuilder: (context, error, stackTrace) {
                          AppLogger.error('Error loading add user Lottie', error: error, stackTrace: stackTrace);
                          return Icon(
                            Icons.person_add_alt_1_outlined, // Icône de fallback stylisée
